...
our_simulation = load_dict('R_PPI2_our_simulation_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
degree_simulation = load_dict('R_PPI2_degree_simulation_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
laplacian_simulation = load_dict('R_PPI2_laplacian_simulation_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
...
# plt.yscale('log')
# plt.axis('equal')
plt.savefig('R_PPI2_'+str(int(100*a))+'_'+str(int(100*b))+'.pdf',dpi=300)
plt.show()