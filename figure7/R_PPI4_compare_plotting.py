...
a=1.1
b=1
simulation_indexs = load_dict('R_PPI4_simulation_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
theory_indexs = load_dict('R_PPI4_theory_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
...
plt.yscale('log')
# plt.axis('equal')
plt.savefig('R_PPI4_compare_'+str(int(100*a))+'_'+str(int(100*b))+'.pdf',dpi=300,bbox_inches='tight')
plt.show()