...
save_dict(np.mat(simulation_indexs), 'R_PPI4_simulation_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(theory_indexs), 'R_PPI4_theory_'+str(int(100*a))+'_'+str(int(100*b)))