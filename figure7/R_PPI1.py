...
A_edge=np.mat(loadmat('../Networks/PPI1.mat')['A'])
...
source=69 #np.random.choice(G_edge.nodes,1)[0]
...
save_dict(np.mat(our_simulation), 'R_PPI1_our_simulation_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(degree_simulation), 'R_PPI1_degree_simulation_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(laplacian_simulation), 'R_PPI1_laplacian_simulation_'+str(int(100*a))+'_'+str(int(100*b)))

save_dict(np.mat(xs_our), 'R_PPI1_xs_our_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(ts_our), 'R_PPI1_ts_our_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(xs_degree), 'R_PPI1_xs_degree_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(ts_degree), 'R_PPI1_ts_degree_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(xs_laplacian), 'R_PPI1_xs_laplacian_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(ts_laplacian), 'R_PPI1_ts_laplacian_'+str(int(100*a))+'_'+str(int(100*b)))