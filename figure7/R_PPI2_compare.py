...
k1=1
k2=100
sources=[69, ] #np.random.choice(G_edge.nodes,k1) #[196, 55, 107]
...
save_dict(np.mat(simulation_indexs), 'R_PPI2_simulation_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(theory_indexs), 'R_PPI2_theory_'+str(int(100*a))+'_'+str(int(100*b)))