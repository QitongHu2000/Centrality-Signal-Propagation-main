...
save_dict(np.mat(our_simulation), 'R_BA_our_simulation_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(degree_simulation), 'R_BA_degree_simulation_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(laplacian_simulation), 'R_BA_laplacian_simulation_'+str(int(100*a))+'_'+str(int(100*b)))

save_dict(np.mat(xs_our), 'R_BA_xs_our_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(ts_our), 'R_BA_ts_our_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(xs_degree), 'R_BA_xs_degree_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(ts_degree), 'R_BA_ts_degree_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(xs_laplacian), 'R_BA_xs_laplacian_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(ts_laplacian), 'R_BA_ts_laplacian_'+str(int(100*a))+'_'+str(int(100*b)))