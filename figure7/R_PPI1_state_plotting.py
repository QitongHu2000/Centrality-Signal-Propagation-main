...
xs_our=load_dict('R_PPI1_xs_our_'+str(int(100*a))+'_'+str(int(100*b)))
xs_our=np.mean(xs_our,axis=1).T.tolist()[0]
ts_our=load_dict('R_PPI1_ts_our_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
ts_our=[i-200 for i in ts_our]
xs_degree=load_dict('R_PPI1_xs_degree_'+str(int(100*a))+'_'+str(int(100*b)))
xs_degree=np.mean(xs_degree,axis=1).T.tolist()[0]
ts_degree=load_dict('R_PPI1_ts_degree_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
ts_degree=[i-200 for i in ts_degree]
xs_laplacian=load_dict('R_PPI1_xs_laplacian_'+str(int(100*a))+'_'+str(int(100*b)))
xs_laplacian=np.mean(xs_laplacian,axis=1).T.tolist()[0]
ts_laplacian=load_dict('R_PPI1_ts_laplacian_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
...
# plt.yscale('log')
# plt.axis('equal')
plt.savefig('R_PPI1_state_'+str(int(100*a))+'_'+str(int(100*b))+'.pdf',dpi=300)
plt.show()