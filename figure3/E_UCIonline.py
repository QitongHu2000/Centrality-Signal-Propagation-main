...
k1=1
k2=100
sources=[41,] #np.random.choice(G_edge.nodes,k1) #[196, 55, 107]
...
save_dict(np.mat(simulation_indexs), 'E_UCIonline_simulation_'+str(int(100*B)))
save_dict(np.mat(theory_indexs), 'E_UCIonline_theory_'+str(int(100*B)))