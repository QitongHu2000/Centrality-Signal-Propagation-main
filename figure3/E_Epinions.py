...
k1=1
k2=100
sources=[62, ] #np.random.choice(G_edge.nodes,k1, replace=False) #[196, 55, 107]
...
save_dict(np.mat(simulation_indexs), 'E_Epinions_simulation_'+str(int(100*B)))
save_dict(np.mat(theory_indexs), 'E_Epinions_theory_'+str(int(100*B)))