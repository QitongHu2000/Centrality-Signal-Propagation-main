...
A_edge=np.mat(loadmat('../Networks/BA2.mat')['A'])
...
k1=1
k2=100
sources=[681, ] #np.random.choice(G_edge.nodes,k1) #[196, 55, 107]
...
save_dict(np.mat(simulation_indexs), 'E_BA_simulation_'+str(int(100*B)))
save_dict(np.mat(theory_indexs), 'E_BA_theory_'+str(int(100*B)))