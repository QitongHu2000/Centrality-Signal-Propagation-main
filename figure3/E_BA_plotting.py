...
simulation_indexs = load_dict('E_BA_simulation_'+str(int(100*B))).tolist()[0]
theory_indexs = load_dict('E_BA_theory_'+str(int(100*B))).tolist()[0]
...
plt.yscale('log')
# plt.axis('equal')
plt.savefig('E_BA_'+str(int(100*B))+'.pdf',dpi=300,bbox_inches='tight')
plt.show()