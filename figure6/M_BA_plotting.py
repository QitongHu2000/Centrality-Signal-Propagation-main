...
our_simulation = load_dict('M_BA_our_simulation_'+str(int(100*B))+'_'+str(int(100*C))).tolist()[0]
degree_simulation = load_dict('M_BA_degree_simulation_'+str(int(100*B))+'_'+str(int(100*C))).tolist()[0]
laplacian_simulation = load_dict('M_BA_laplacian_simulation_'+str(int(100*B))+'_'+str(int(100*C))).tolist()[0]
...
# plt.yscale('log')
# plt.axis('equal')
plt.savefig('M_BA_'+str(int(100*B))+'_'+str(int(100*C))+'.pdf',dpi=300)
plt.show()