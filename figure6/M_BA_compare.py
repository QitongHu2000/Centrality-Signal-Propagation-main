...
save_dict(np.mat(simulation_indexs), 'M_BA_simulation_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(theory_indexs), 'M_BA_theory_'+str(int(100*B))+'_'+str(int(100*C)))