...
C=0.1
a=1
simulation_indexs = load_dict('M_ECO1_simulation_'+str(int(100*B))+'_'+str(int(100*C))).tolist()[0]
theory_indexs = load_dict('M_ECO1_theory_'+str(int(100*B))+'_'+str(int(100*C))).tolist()[0]
...
plt.yscale('log')
# plt.axis('equal')
plt.savefig('M_ECO1_compare_'+str(int(100*B))+'_'+str(int(100*C))+'.pdf',dpi=300,bbox_inches='tight')
plt.show()