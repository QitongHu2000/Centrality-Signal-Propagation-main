...
source=68 #np.random.choice(G_edge.nodes,1)[0]
...
save_dict(np.mat(our_simulation), 'M_ECO1_our_simulation_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(degree_simulation), 'M_ECO1_degree_simulation_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(laplacian_simulation), 'M_ECO1_laplacian_simulation_'+str(int(100*B))+'_'+str(int(100*C)))

save_dict(np.mat(xs_our), 'M_ECO1_xs_our_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(ts_our), 'M_ECO1_ts_our_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(xs_degree), 'M_ECO1_xs_degree_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(ts_degree), 'M_ECO1_ts_degree_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(xs_laplacian), 'M_ECO1_xs_laplacian_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(ts_laplacian), 'M_ECO1_ts_laplacian_'+str(int(100*B))+'_'+str(int(100*C)))