...
def Jac(A,x):
    J_=-B/C*a*np.diag(np.power(x,a).T.tolist()[0])
...
A_edge=np.mat(loadmat('../Networks/ECO2.mat')['A'])
...
source=109 #np.random.choice(G_edge.nodes,1)[0]
...
save_dict(np.mat(our_simulation), 'M_ECO2_our_simulation_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(degree_simulation), 'M_ECO2_degree_simulation_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(laplacian_simulation), 'M_ECO2_laplacian_simulation_'+str(int(100*B))+'_'+str(int(100*C)))

save_dict(np.mat(xs_our), 'M_ECO2_xs_our_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(ts_our), 'M_ECO2_ts_our_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(xs_degree), 'M_ECO2_xs_degree_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(ts_degree), 'M_ECO2_ts_degree_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(xs_laplacian), 'M_ECO2_xs_laplacian_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(ts_laplacian), 'M_ECO2_ts_laplacian_'+str(int(100*B))+'_'+str(int(100*C)))