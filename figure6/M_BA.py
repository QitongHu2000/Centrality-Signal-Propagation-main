...
A_edge=np.mat(loadmat('../Networks/BA.mat')['A'])
...
save_dict(np.mat(our_simulation), 'M_BA_our_simulation_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(degree_simulation), 'M_BA_degree_simulation_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(laplacian_simulation), 'M_BA_laplacian_simulation_'+str(int(100*B))+'_'+str(int(100*C)))

save_dict(np.mat(xs_our), 'M_BA_xs_our_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(ts_our), 'M_BA_ts_our_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(xs_degree), 'M_BA_xs_degree_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(ts_degree), 'M_BA_ts_degree_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(xs_laplacian), 'M_BA_xs_laplacian_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(ts_laplacian), 'M_BA_ts_laplacian_'+str(int(100*B))+'_'+str(int(100*C)))