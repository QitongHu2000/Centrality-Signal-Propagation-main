...
k1=1
k2=100
sources=[109, ] #np.random.choice(G_edge.nodes,k1) #[196, 55, 107]
...
save_dict(np.mat(simulation_indexs), 'M_ECO2_simulation_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(theory_indexs), 'M_ECO2_theory_'+str(int(100*B))+'_'+str(int(100*C)))