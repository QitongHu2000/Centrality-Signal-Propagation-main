...
source=681 #np.random.choice(G_edge.nodes,1)[0]
...
save_dict(np.mat(our_simulation), 'E_BA_our_simulation_'+str(int(100*B)))
save_dict(np.mat(degree_simulation), 'E_BA_degree_simulation_'+str(int(100*B)))
save_dict(np.mat(laplacian_simulation), 'E_BA_laplacian_simulation_'+str(int(100*B)))

save_dict(np.mat(xs_our), 'E_BA_xs_our_'+str(int(100*B)))
save_dict(np.mat(ts_our), 'E_BA_ts_our_'+str(int(100*B)))
save_dict(np.mat(xs_degree), 'E_BA_xs_degree_'+str(int(100*B)))
save_dict(np.mat(ts_degree), 'E_BA_ts_degree_'+str(int(100*B)))
save_dict(np.mat(xs_laplacian), 'E_BA_xs_laplacian_'+str(int(100*B)))
save_dict(np.mat(ts_laplacian), 'E_BA_ts_laplacian_'+str(int(100*B)))