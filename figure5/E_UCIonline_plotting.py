...
our_simulation = load_dict('E_UCIonline_our_simulation_'+str(int(100*B))).tolist()[0]
degree_simulation = load_dict('E_UCIonline_degree_simulation_'+str(int(100*B))).tolist()[0]
laplacian_simulation = load_dict('E_UCIonline_laplacian_simulation_'+str(int(100*B))).tolist()[0]
...
# plt.yscale('log')
# plt.axis('equal')
plt.savefig('E_UCIonline_'+str(int(100*B))+'.pdf',dpi=300)
plt.show()