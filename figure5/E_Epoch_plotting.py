...
our_simulation = load_dict('E_Epoch_our_simulation_'+str(int(100*B))).tolist()[0]
degree_simulation = load_dict('E_Epoch_degree_simulation_'+str(int(100*B))).tolist()[0]
laplacian_simulation = load_dict('E_Epoch_laplacian_simulation_'+str(int(100*B))).tolist()[0]
...
plt.ylabel(r"$\Vert \Delta \mathbf{x}\Vert_2$",fontsize=35)
...
# plt.yscale('log')
# plt.axis('equal')
plt.savefig('E_Epoch_'+str(int(100*B))+'.pdf',dpi=300)
plt.show()